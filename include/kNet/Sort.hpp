...
template <typename T>
void SelectionSort(T* list, int numItems)
{
    SelectionSort<T>(list, numItems, TriCmp<T>);
}
template <typename T>
void InsertionSort(T* list, int numItems)
{
    InsertionSort<T>(list, numItems, TriCmp<T>);
}
template <typename T>
void ShellSort(T* list, int numItems)
{
    ShellSort<T>(list, numItems, TriCmp<T>);
}
template <typename T>
void BubbleSort(T* list, int numItems)
{
    BubbleSort<T>(list, numItems, TriCmp<T>);
}
template <typename T>
void CocktailSort(T* list, int numItems)
{
    CocktailSort<T>(list, numItems, TriCmp<T>);
}
template <typename T>
void CombSort(T* list, int numItems)
{
    CombSort<T>(list, numItems, TriCmp<T>);
}
template <typename T>
void MergeSort(T* list, int numItems)
{
    MergeSort<T>(list, numItems, TriCmp<T>);
}
template <typename T>
void QuickSort(T* list, int numItems)
{
    QuickSort<T>(list, numItems, TriCmp<T>);
}

template <typename T>
void HeapSort(T* list, int numItems)
{
    HeapSort<T>(list, numItems, TriCmp<T>);
}
template <typename T>
void IntroSort(T* list, int numItems, int nMaxRecursionLevels = 1000)
{
    IntroSort<T>(list, numItems, nMaxRecursionLevels, TriCmp<T>);
}
