...
template <typename T, typename PriorityCmp = sort::TriCmpObj<T>, typename EqualCmp = sort::TriCmpObj<T>,
    typename LookupNotify = EmptyLookupNotify<T>, typename AllocT = StdCAlloc>
class MaxHeap
{
public:
